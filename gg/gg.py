                        ...
                        if str(message.content).lower() == "nnn" :
                            ...
                            if nnn_role in message.author.roles :
                                ...
                                try :
                                    ...
                                    await message.reply("Congrats comrade, you are a warrior. Gajju welcomes you to the NNN gang. Remember, no jerking off for the whole November, if you do you're a weakling.", delete_after=2)
                                except :
                                    pass
